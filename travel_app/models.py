...
class WishList(models.Model):
    ...
    hotels = models.ManyToManyField(Hotel, related_name="wishlists", blank=True)
    activities = models.ManyToManyField(Activity, related_name="wishlists", blank=True)
    packages = models.ManyToManyField(TravelPackage, related_name="wishlists", blank=True)
